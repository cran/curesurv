#' @title pt_cure_ic_adtneh2_loglog function
#'
...
#'
#' @param cumLexctopred a pre-prediction parameter obtained with cumLexc_ad2_topred, if NULL it will be calculated here
#'
#' @param Dpt_cure Partial derivatives of the cure propability according to theta, if NULL it will be calculated here
#'
...
pt_cure_ic_adtneh2_loglog = function(z_tau = z_tau,
                                     z_alpha = z_alpha,
                                     x = x,
                                     object,
                                     level = level,
  ...
  if(is.null(Dpt_cure)){
    Dpt_cure <- dpdtheta_adtneh2(z_tau = z_tau,
                                 z_alpha = z_alpha,
                                 x = x,
                                 object,
